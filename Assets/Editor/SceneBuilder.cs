...
public static class SceneBuilder
{
    ...
    public static void BuildScene()
    {
        ...
        PF(prestigeShopPanel, 205, 1761);

        Panel(prestigeShopPanel, "PrestigeShopCardBg", 0, 1761, HC("150A30"), 24);
        ...
        // Row 22 — Endurance (+0.5 HP/s universal regen per level)
        var pEnduranceInfoGO = Label(prestigeShopPanel, "PEnduranceInfoText",
            "Endurance +0.5 HP/s universal regen  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(pEnduranceInfoGO, 1278, 48, -175, 500);
        var pEnduranceBtnGO = Btn(prestigeShopPanel, "PEnduranceButton", "Buy (1 PP)", 30, HC("1565C0"));
        PT(pEnduranceBtnGO, 1276, 54, +245, 260);

        // Row 23 — Forge Master (+1 atk per weapon level per perk level)
        var pForgeMasterInfoGO = Label(prestigeShopPanel, "PForgeMasterInfoText",
            "Forge Master +1 atk per weapon level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        ...
        var pTidalSurgeInfoGO = Label(prestigeShopPanel, "PTidalSurgeInfoText",
            "Tidal Surge +2s Surge duration per level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(pTidalSurgeInfoGO, 1452, 48, -175, 500);
        var pTidalSurgeBtnGO = Btn(prestigeShopPanel, "PTidalSurgeButton", "Buy (1 PP)", 30, HC("0277BD"));
        PT(pTidalSurgeBtnGO, 1450, 54, +245, 260);

        var pHexMasterInfoGO = Label(prestigeShopPanel, "PHexMasterInfoText",
            "Hex Master +5pct HexCurse atk reduction per level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        ...
        var pCompoundInterestInfoGO = Label(prestigeShopPanel, "PCompoundInterestInfoText",
            "Compound Interest +0.5pct bank interest rate per level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(pCompoundInterestInfoGO, 1626, 48, -175, 500);
        var pCompoundInterestBtnGO = Btn(prestigeShopPanel, "PCompoundInterestButton", "Buy (1 PP)", 30, HC("00695C"));
        PT(pCompoundInterestBtnGO, 1624, 54, +245, 260);

        var pWarBannerInfoGO = Label(prestigeShopPanel, "PWarBannerInfoText",
            "War Banner +0.25 WarCry multiplier per level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(pWarBannerInfoGO, 1684, 48, -175, 500);
        var pWarBannerBtnGO = Btn(prestigeShopPanel, "PWarBannerButton", "Buy (1 PP)", 30, HC("AD1457"));
        PT(pWarBannerBtnGO, 1682, 54, +245, 260);
        ...
        // Row 29 — Blood Sigil (tier-1, costs 1 shard)
        var ssBloodSigilInfoGO = Label(soulShardShopPanel, "SSBloodSigilInfoText",
            "Blood Sigil HealSelf deals equal damage to enemy  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(ssBloodSigilInfoGO, 1686, 48, -175, 500);
        var ssBloodSigilBtnGO = Btn(soulShardShopPanel, "SSBloodSigilButton", "Buy (1 ⬡)", 30, HC("B71C1C"));
        PT(ssBloodSigilBtnGO, 1684, 54, +245, 260);

        var ssEchoBlastInfoGO = Label(soulShardShopPanel, "SSEchoBlastInfoText",
            "Echo Blast Surge expiry fires free Blood Storm  (Lv.0/2)", 30, TextSec, TextAnchor.MiddleLeft);
        ...
        var ssSoulRendInfoGO = Label(soulShardShopPanel, "SSSoulRendInfoText",
            "Soul Rend Blood Storm reduces enemy atk 20pct/lv for 5s  (Lv.0/2)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(ssSoulRendInfoGO, 1860, 48, -175, 500);
        var ssSoulRendBtnGO = Btn(soulShardShopPanel, "SSSoulRendButton", "Buy (2 ⬡)", 30, HC("6A1B9A"));
        PT(ssSoulRendBtnGO, 1858, 54, +245, 260);

        var ssLifeTapInfoGO = Label(soulShardShopPanel, "SSLifeTapInfoText",
            "Life Tap soldiers heal 5pct of dmg dealt per level  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(ssLifeTapInfoGO, 1918, 48, -175, 500);
        var ssLifeTapBtnGO = Btn(soulShardShopPanel, "SSLifeTapButton", "Buy (1 ⬡)", 30, HC("2E7D32"));
        PT(ssLifeTapBtnGO, 1916, 54, +245, 260);

        var ssSurgeShieldInfoGO = Label(soulShardShopPanel, "SSSurgeShieldInfoText",
            "Surge Shield Surge activation grants BloodShield 15pct frontline HP/lv  (Lv.0/2)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(ssSurgeShieldInfoGO, 1976, 48, -175, 500);
        var ssSurgeShieldBtnGO = Btn(soulShardShopPanel, "SSSurgeShieldButton", "Buy (2 ⬡)", 30, HC("1565C0"));
        PT(ssSurgeShieldBtnGO, 1974, 54, +245, 260);

        var ssBloodPyreInfoGO = Label(soulShardShopPanel, "SSBloodPyreInfoText",
            "Blood Pyre soldier death deals 30pct of dying HP as burst dmg/lv  (Lv.0/2)", 30, TextSec, TextAnchor.MiddleLeft);
        PT(ssBloodPyreInfoGO, 2034, 48, -175, 500);
        var ssBloodPyreBtnGO = Btn(soulShardShopPanel, "SSBloodPyreButton", "Buy (2 ⬡)", 30, HC("BF360C"));
        PT(ssBloodPyreBtnGO, 2032, 54, +245, 260);

        var ssGraveRobberInfoGO = Label(soulShardShopPanel, "SSGraveRobberInfoText",
            "Grave Robber 15pct chance per level for bonus shard on boss kill  (Lv.0/3)", 30, TextSec, TextAnchor.MiddleLeft);
        ...
        uim.pEnduranceInfoText           = pEnduranceInfoGO.GetComponent<Text>();
        ...
        uim.pTidalSurgeInfoText          = pTidalSurgeInfoGO.GetComponent<Text>();
        ...
        uim.pCompoundInterestInfoText    = pCompoundInterestInfoGO.GetComponent<Text>();
        uim.pCompoundInterestButton      = pCompoundInterestBtnGO.GetComponent<Button>();
        uim.pWarBannerInfoText           = pWarBannerInfoGO.GetComponent<Text>();
        uim.pWarBannerButton             = pWarBannerBtnGO.GetComponent<Button>();
        ...
        uim.ssBloodSigilInfoText    = ssBloodSigilInfoGO.GetComponent<Text>();
        ...
        uim.ssSoulRendInfoText      = ssSoulRendInfoGO.GetComponent<Text>();
        uim.ssSoulRendButton        = ssSoulRendBtnGO.GetComponent<Button>();
        uim.ssLifeTapInfoText       = ssLifeTapInfoGO.GetComponent<Text>();
        uim.ssLifeTapButton         = ssLifeTapBtnGO.GetComponent<Button>();
        uim.ssSurgeShieldInfoText   = ssSurgeShieldInfoGO.GetComponent<Text>();
        uim.ssSurgeShieldButton     = ssSurgeShieldBtnGO.GetComponent<Button>();
        uim.ssBloodPyreInfoText     = ssBloodPyreInfoGO.GetComponent<Text>();
        ...
        UnityEventTools.AddPersistentListener(pCompoundInterestBtnGO.GetComponent<Button>().onClick, clk.OnBuyPCompoundInterest);
        UnityEventTools.AddPersistentListener(pWarBannerBtnGO.GetComponent<Button>().onClick,        clk.OnBuyPWarBanner);
        ...
        UnityEventTools.AddPersistentListener(ssSoulRendBtnGO.GetComponent<Button>().onClick,      clk.OnBuySSSoulRend);
        UnityEventTools.AddPersistentListener(ssLifeTapBtnGO.GetComponent<Button>().onClick,       clk.OnBuySSLifeTap);
